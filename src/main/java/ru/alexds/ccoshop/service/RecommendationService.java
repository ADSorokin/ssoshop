...
public class RecommendationService {
    ...
    private static final double VIGILANCE_PARAMETER = 0.5; // Параметр бдительности для ART кластеризации
    private static final double LEARNING_RATE = 0.2; // Коэффициент обучения для ART кластеризации
    ...
    public double calculateSimilarityScore(Long productId, List<Long> userProductIds) {
        ...
        double contentWeight = 0.7; // Вес метаданных
        double metadataSimilarity=0;
